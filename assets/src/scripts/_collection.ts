...
namespace Collection {
  ...
  * utility
  ...
  var utility = {
    ...
    makeAccessor: function(targetObject:any = null, configuration:any = null, getter:any = null, setter:any = null) {
      // prototype設定
    ...
    makeAccessorOnlyGetter: function(targetObject:any = null, configuration:any = null, getter:any = null) {
      for (var key in configuration) {
        var value = configuration[key];
        var prototypes = {
          get: getter,
  ...
  *
  ------------------------------------------------ */
  function SetIterator__(Set__instance:any = null) {
  ...
  *
  ------------------------------------------------ */
  export function Set__(a:any = null) {
  ...
  *
  ------------------------------------------------ */
  function ListIterator__(List__instance:any = null) {
  ...
  ListIterator__.prototype.map = function(callback) {
    ...
    var List__instance = new List__(null);
  ...
  *
  ------------------------------------------------ */ 
  function ListIteratorBackwards__(List__instance:any = null) {
    this.List__instance_ = List__instance;
    this.reset()
  }
  ...
  ListIteratorBackwards__.prototype.each = function(callback) {
    ...
    this.index_ = e;
    for (e -= 1; 0 <= e; e--) {
      callback(this.List__instance_.valueArray_[e], e);
    }
    return this;
  };
  ...
  *
  ------------------------------------------------ */
  export function List__(a:any = null) {
    utility.numberHashId(this);
    this.isFrozenFlag = false;
    this.valueArray_ = [];
    this.actionCount_ = 0;
  ...
  List__.prototype.sortRange = function(a, b, c) {
    ...
    if (0 === b) {
      if (c >= e) {
        ...
        for (h = d.slice(0, c), h.sort(a), a = 0; a < c; a++) {
          d[a] = h[a];
        }
      }
    }
    else if (c >= e) {
      for (h = d.slice(b), h.sort(a), a = b; a < e; a++) {
        d[a] = h[a - b];
      }
    }
    else {
      for (h = d.slice(b, c), h.sort(a), a = b; a < c; a++) {
        d[a] = h[a - b];
      }
    }
  ...
  *
  ------------------------------------------------ */
  function MapKeySetIterator__(Map__instance:any = null) {
  ...
  *
  ------------------------------------------------ */
  function MapKeySet__(Map__instance:any = null) {
    utility.numberHashId(this);
    this.isFrozenFlag = true;
    this.Map__instance_ = Map__instance;
  }
  ...
  *
  ------------------------------------------------ */
  function MapValueSetIterator__(Map__instance:any = null) {
    this.Map__instance_ = Map__instance;
    this.reset();
  }
  ...
  *
  ------------------------------------------------ */
  function MapValueSet__(key:any = null, value:any = null) {
    utility.numberHashId(this);
    this.key = key;
    this.value = value;
  ...
  *
  ------------------------------------------------ */
  function MapIterator__(Map__instance:any = null) {
    this.Map__instance_ = Map__instance;
    this.reset();
  }
  ...
  *
  ------------------------------------------------ */
  export function Map__(a:any = null, b:any = null) {
    utility.numberHashId(this);
    this.isFrozenFlag = false;
  ...
  // 配列の各要素に対してコールバック関数を呼び出し、
  // 結果を含むMap__インスタンスを返す
  // let images = itemsMap.map(function(item) {
  //   return 'Key:' + item.key;
  // });
  ...
  // let images = itemsMap.filter(function(item) {
  //   if(item.value.images !== void 0) {
  //     return true;
  //   }
  // });
